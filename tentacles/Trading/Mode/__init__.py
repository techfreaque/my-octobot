...
if check_tentacle_version('1.0.0', 'arbitrage_pro_trading_mode', 'Matrix-Strategies'):
    try:
...
if check_tentacle_version('0.4.0', 'lorentzian_classification', 'Matrix-Strategies'):
    try:
...
if check_tentacle_version('1.0.0', 'strategy_maker_trading_mode', 'Matrix-Strategy-Maker'):
    try:
...
if check_tentacle_version('1.0.0', 'spot_master_3000_trading_mode', 'Spot-Master-3000'):
    try:
...
if check_tentacle_version('1.0.0', 'semi_auto_trading_mode', 'Semi-Auto-Trading-Mode'):
    try:
