...
from ...ascendex_websocket_feed import AscendexCCXTWebsocketConnector
...
async def test_start_spot_websocket():
    ...
    async with websocket_test_tools.ws_exchange_manager(config, AscendexCCXTWebsocketConnector.get_name()) \
        ...
        await websocket_test_tools.test_unauthenticated_push_to_channel_coverage_websocket(
            ...
            websocket_connector_class=AscendexCCXTWebsocketConnector,
