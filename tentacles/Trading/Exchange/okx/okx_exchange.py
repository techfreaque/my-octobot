...
class Okx(exchanges.RestExchange):
    ...
    async def _create_market_buy_order(self, symbol, quantity, price=None, tag: str = None, params=None) -> dict:
        """
    ...
    async def _create_market_sell_order(self, symbol, quantity, price=None, tag: str = None, params=None) -> dict:
        """
        Add price to default connector call for market orders https://github.com/ccxt/ccxt/issues/9523
        """
